...
class DatadogClient:
    """Client for querying Datadog logs, events, and monitors."""
    ...
    def search_logs(
        ...
        Args:
            query: Datadog log query (e.g., 'service:my-app status:error')
    ...
    def list_monitors(
        ...
        Args:
            query: Optional filter (e.g., 'tag:pipeline:my-pipeline')
        """
